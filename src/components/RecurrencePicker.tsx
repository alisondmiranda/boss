...
export function RecurrencePicker({ value, onChange, isOpen, onClose, triggerRef }: RecurrencePickerProps) {
                ...
                <FloatingPortal>
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-surface border border-outline-variant shadow-5 rounded-2xl p-2 w-[320px] z-[100] flex flex-col gap-1"
                        >
